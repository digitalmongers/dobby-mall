...
//       onClose(); // or redirect to success screen
//     } catch (error: any) {
//       console.error(error);
...
//           <div className="mb-8">
//             <h1 className="text-2xl font-semibold text-gray-900 mb-2">Register as Student</h1>
//             <p className="text-gray-600 text-sm">Complete your profile for exclusive offers and updates</p>
//           </div>
...
//               value={formData.parentName}
//               onChange={handleInputChange}
//               className="w-full px-4 py-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 text-sm"
//             />
...
//                 value={formData.parentMobile}
//                 onChange={handleInputChange}
//                 className="flex-1 px-4 py-4 border border-gray-200 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 text-sm"
//               />
//             </div>
...
//               onChange={handleInputChange}
//               rows={4}
//               className="w-full px-4 py-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 text-sm resize-none"
//             />
...
//               <button
//                 type="button"
//                 className={`w-full ${loading ? 'bg-blue-300' : 'bg-blue-500 hover:bg-blue-600'} text-white py-4 px-4 rounded-lg font-medium text-sm transition-colors`}
//                 onClick={handleSubmit}
//                 disabled={loading}
//               >
